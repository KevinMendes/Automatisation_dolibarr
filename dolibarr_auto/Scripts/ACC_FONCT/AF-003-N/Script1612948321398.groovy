...
WebUI.verifyElementPresent(findTestObject('AF-003-N/Page_Configuration/div_Projets_mainmenu billing topmenuimage'), 0)

WebUI.verifyElementPresent(findTestObject('AF-003-N/Page_Configuration/div_Services_mainmenu project topmenuimage'), 0)

WebUI.verifyElementPresent(findTestObject('AF-003-N/Page_Configuration/div_Tiers_mainmenu products topmenuimage'), 0)

WebUI.verifyElementPresent(findTestObject('AF-003-N/Page_Configuration/div_Accueil_mainmenu companies topmenuimage'), 0)
